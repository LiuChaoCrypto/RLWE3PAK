...
all:
	...
	$(CC) $(CCFLAGS) -Wno-unused-function -c getmd5.c
	$(CC) $(CCFLAGS) -Wno-unused-function -c ringsub.c
	$(CC) $(CCFLAGS) -Wno-unused-function -Wno-unused-parameter -c rlwe_rand.c
	$(CC) $(CCFLAGS) -o rlwe_main rlwe_main.c fft.o rlwe.o rlwe_kex.o rlwe_rand.o getmd5.o ringsub.o $(LDFLAGS)
	$(CC) $(CCFLAGS) -o rlwe_benchmark rlwe_benchmark.c fft.o rlwe.o rlwe_kex.o rlwe_rand.o getmd5.o ringsub.o $(LDFLAGS)
	$(CC) $(CCFLAGS) -Wno-unused-function -o rlwe_test rlwe_test.c fft.o rlwe_kex.o rlwe_rand.o getmd5.o ringsub.o $(LDFLAGS)

clean:
	rm fft.o rlwe.o rlwe_kex.o rlwe_rand.o getmd5.o ringsub.o rlwe_main rlwe_benchmark rlwe_test
